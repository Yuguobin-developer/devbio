  ...
  <tr valign="top">
      <th scope="row">
        ...
        <?php helpers\App::info_tooltip('mpcs-courses-slug',
                __('Classroom Slug', 'memberpress-courses'),
    ...
    <tr valign="top" class="requires-classroom-mode <?php echo helpers\Options::val($options,'classroom-mode') ? '' : 'hidden'; ?>">
      <th scope="row">
        <label for="mpcs-options[button-location]"><?php esc_html_e('Lesson Button Location', 'memberpress-courses'); ?></label>
        <?php helpers\App::info_tooltip('mpcs-lesson-button-location',
      ...
      <td>
        <select id="mpcs-options[lesson-button-location]" name="mpcs-options[lesson-button-location]">
          <option value="top" <?php selected(helpers\Options::val($options,'lesson-button-location'), 'top'); ?>><?php esc_html_e('Top', 'memberpress-courses'); ?></option>
          <option value="bottom" <?php selected(helpers\Options::val($options,'lesson-button-location'), 'bottom'); ?>><?php esc_html_e('Bottom', 'memberpress-courses'); ?></option>
          <option value="both" <?php selected(helpers\Options::val($options,'lesson-button-location'), 'both'); ?>><?php esc_html_e('Both', 'memberpress-courses'); ?></option>
        </select>
      </td>
    </tr>
    ...
    <tr valign="top" class="requires-classroom-mode <?php echo helpers\Options::val($options,'classroom-mode') ? '' : 'hidden'; ?>">
      <th scope="row">
        <label for="mpcs-options[complete-link-css]"><?php _e('WP Footer Hook', 'memberpress-courses'); ?></label>
        <?php helpers\App::info_tooltip('mpcs-complete-link-css',
                __('WP Footer Hook', 'memberpress-courses'),
                __('Use this field to enable/disable the WP Footer hook. In classroom mode, \'wp_footer\' hook is disabled by default.', 'memberpress-courses'));
        ?>
      </th>
      <td>
        <select id="mpcs-options[classroom-wp-footer]" name="mpcs-options[classroom-wp-footer]">
          <option value="disabled" <?php selected(helpers\Options::val($options,'classroom-wp-footer'), 'disabled'); ?>><?php esc_html_e('Disabled', 'memberpress-courses'); ?></option>
          <option value="enabled" <?php selected(helpers\Options::val($options,'classroom-wp-footer'), 'enabled'); ?>><?php esc_html_e('Enabled', 'memberpress-courses'); ?></option>
        </select>
      </td>
    </tr>
