...
function adrotate_credits() {
	...
	<p><a href="https://ajdg.solutions/product/adrotate-pro-single/?mtm_campaign=adrotatefree&mtm_keyword=credits&mtm_content=single" target="_blank"><strong>'.__('Single License', 'adrotate').' (&euro; 39.00)</strong></a><br /><em>'.__('Use on ONE WordPress installation.', 'adrotate').' <a href="https://ajdg.solutions/?add-to-cart=1124&mtm_campaign=adrotatefree&mtm_keyword=credits&mtm_content=single" target="_blank">'.__('Buy now', 'adrotate').' &raquo;</a></em></p>
	<p><a href="https://ajdg.solutions/product/adrotate-pro-multi/?mtm_campaign=adrotatefree&mtm_keyword=credits&mtm_content=multi" target="_blank"><strong>'.__('Multi License', 'adrotate').' (&euro; 99.00)</strong></a><br /><em>'.__('Use on up to FIVE WordPress installations.', 'adrotate').' <a href="https://ajdg.solutions/?add-to-cart=1128&mtm_campaign=adrotatefree&mtm_keyword=credits&mtm_content=multi" target="_blank">'.__('Buy now', 'adrotate').' &raquo;</a></em></p></td>';
