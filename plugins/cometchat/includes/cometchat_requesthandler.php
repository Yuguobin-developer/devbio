...
if(!empty($_REQUEST['api']) && $_REQUEST['api'] == 'cometchat_update_layout_ajax') {
	cometchat_update_layout_ajax();
}
...
function cometchat_update_layout_ajax() {
	$response = array();
	$show_docked_layout_on_all_pages = (!empty($_POST['show_docked_layout_on_all_pages'])) ? $_POST['show_docked_layout_on_all_pages'] : '';
