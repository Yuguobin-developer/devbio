...
wp_enqueue_script("comet-clipboard", dirname(plugin_dir_url( __FILE__ )).'/js/clipboard.js');
...
<body>
	<div class="tabs">
		...
		<ul class="tab-links" id = "submenu">
			...
			<li data-rel="cc_layoutsettings" class="menus"><a href="#cc_layoutsettings">Layout Settings</a></li>
		...
		<div class="tab-content">
			...
			<div id="cc_layoutsettings" class="tab">
				<table cellspacing="1" style="margin-top:20px;">
					<tr style="margin-top:20px;">
						<td width="550" style="padding-top: 20px;">
							...
							<p>
								Please check this option to add CometChat’s docked layout to ALL pages. If you wish to include this layout only on select pages, please uncheck this option and add the shortcode [ShortCode Here] on the desired page/s.
							</p>
							<p>
								Docked Layout Shortcode -
								<div class="codebox"><pre data-keep-tags="highlight" class=" language-php"><code class=" language-php"><span class="token punctuation">[</span>cometchat layout<span class="token operator">=</span><span class="token string">'docked'</span><span class="token punctuation">]</span></code></pre><button id="copy_docked_shortcode" class="copy">COPY</button></div>
							</p>
						</td>
