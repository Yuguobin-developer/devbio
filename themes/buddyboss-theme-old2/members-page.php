                ...
                <?php $user = wp_get_current_user();  if(true): ?>
                    ...
                    <div class="people_grid" id="people_grid">
                        ...
                        <?php foreach($loop as $l): ?>
                            ...
                            <?php $member->ID = $l->ID; $Subscription = $member->active_product_subscriptions(); ?>
                            
                            <?php if( !in_array('test',get_userdata($l->ID)->roles) && (count($Subscription) > 0) /*in_array('memberpress_account',get_userdata($l->ID)->roles))*/ )  :?>
