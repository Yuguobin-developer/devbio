 ...
 * Template name: Funding Page Template
...
-->
            ...
            <div class="row">
                ...
                <div class="col-sm-12" style="padding: 25px 0px 0px 0px;" >
                    <h3 >THERE ARE CURRENTLY <span id='bidsNum' style="font-weight:bold"></span> FUNDING ON BIOGAS COMMUNITY</h3>
                </div>
            ...
            <div class="row">
                <div class="line" style="padding: 25px 0px 0px 0px;" >
                    <h3 >THERE ARE CURRENTLY <span id='bidsNum' style="font-weight:bold"></span> FUNDING OPPORTUNITIES ON BIOGAS COMMUNITY</h3>
                </div>
