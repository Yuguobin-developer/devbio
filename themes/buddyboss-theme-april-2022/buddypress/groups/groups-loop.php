				...
				<div class="item">
					<div class="item-block">
						...
						<?php if ( bp_nouveau_group_has_meta() ) : ?>
							...
							<p><a href="<?php bp_group_permalink(); ?>" class="button">View Group</a></p>
							<p><?php bp_nouveau_groups_loop_buttons(); ?></p>
						<?php endif; ?>
...
?><script>
    jQuery(document).ready(function(){
        var no_groups = parseFloat(jQuery(".buddypress-wrap .bp-navs li.selected a .count").text());
        var output_string = "<sup>(" + no_groups + ")</sup>";
        jQuery(".bb-standard .entry-title").append(output_string);
        //console.log(no_groups);
        
        jQuery("#groups-create a").prepend("+ ");
    });
</script>
