                ...
                <div>
                    <h3>Company name</h3>
                        <p><?php echo $company->post_title; ?></p>
                         <p><a class="button button_dark button_arrow" href="<?= get_field('bid_link', $post->ID); ?>" target="_blank">Opportunity Link</a> <?php $website = get_field("web_site", $company->ID); if(!empty($website)): ?> <a class='button button_dark button_arrow' href="<?php echo $website; ?>" target="_blank">Company website</a><?php endif; ?></p>
                </div>
            ...
            <div id="" class="item_list_wrapper">
                <div class="list_item grid_1_1">
                    ...
                    <div>
                        ...
                        <p<?php echo get_field("deadline_to_apply"); ?></p>
