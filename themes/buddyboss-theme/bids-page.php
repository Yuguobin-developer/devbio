 ...
 * Template name: Public Bids Listing Template
...
<div id="primary" class="content-area">
    ...
    <main id="main" class="site-main">
        <div class="flex grid_flex">
            ...
            <div><a href="<?php echo site_url() . '/add-a-public-bid/'; ?>" class="button">+ Add a public bid</a></div>
        </div>
        ...
        <div id="post_list" class="bids_list" style="">
            ...
            <div class="row bg_form_fields">
                ...
                <div class="col-sm-12" style="padding: 25px 0px 0px 0px;" >
                    <h3 >THERE ARE CURRENTLY <span id='bidsNum' style="font-weight:bold"></span> PUBLIC BIDS ON BIOGAS COMMUNITY</h3>
                </div>
                ...
                <tbody>
                    ...
                    <?php  $a = 0; foreach ($query1 as $value1) { ?>
                        ...
                        if (strtotime(get_field("closing_date", $value1->ID)) >= strtotime(date('Y-m-d'))) : ?>
                            ...
                            <?php $cat = get_field("category", $value1->ID); $a++;
                            $category = "";
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td style="font-weight: bold"><?= $category[0]; ?></td>
