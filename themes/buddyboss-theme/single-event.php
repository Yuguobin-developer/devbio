...
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/css/bg-single.css?id=<?php echo rand(1000,9999); ?>" />
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
            ...
            <div id="" class="item_list_wrapper" style="margin-bottom:10px">
            ...
            <div id="" class="item_list_wrapper">
                <div class="list_item grid_1_1">
                    <div>
                        ...
                        <p><a class="button button_dark button_arrow" href="<?= get_field('field_60bd74893f252', $post->ID); ?>" target="_blank">Direct Link to Event</a></p>
                    </div>
            ...
            <div class="list_item grid_1_1" style="padding: 40px 20px">
                <div>
                    <h3>Location</h3>
                    <p style="color:#006633;"><?php echo get_field("event_location", $post->ID); ?></p>
                </div>
            </div>
...
.item_list_wrapper .list_item p {
    font-size: 26px;
    line-height: 32px;
}
.item_list_wrapper .list_item.grid_1_1 {
    grid-gap: 0em;
}
img.event_poster {
    max-width: 700px;
