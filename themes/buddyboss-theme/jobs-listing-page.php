            ...
            <table class='sortable display responsive' id='Tableau' style="width:100%">
                ...
                <tbody>
                    <?php $a = 0; foreach ($query1 as $value1) { ?>
                        <?php
                            $post_id = intval(get_post_meta( $value1->ID, 'company')[0]);                
                            ...
                            $loc = get_field("location", $value1->ID);

                            $sentence = explode(".", $loc);
                            $words = array_map(function($v){
                                return explode(" ", $v);
                            }, $sentence);
                        
                            $uniqueCountryWord = array_map("array_unique", $words);                 
                           
                        ?>
                        <tr>
                            <td><span style="font-weight: bold;font-size: 20px;">★ </span><a href="<?= $value1->guid; ?>" style="font-weight: bold"><?= $value1->post_title; ?></a></td>
                            <td style="font-weight: bold"><?= get_field("company_name", $value1->ID);   ?></td>
                            <td style="font-weight: bold"><?= get_field("job_domain", $value1->ID);   ?></td>
                            <td style="font-weight: bold"><?php foreach ($uniqueCountryWord[0] as $key => $country) { echo $country." ";   } ?></td>
                            
                            <td  style="font-weight: bold" class="nowrap"><?= date('Y-m-d',strtotime(get_field("deadline_to_apply", $value1->ID))); ?></td>
                        </tr>
                    ...
                    <?php $k = 0; foreach ($query as $value) : ?>
                        ...
                        <?php
                            ...
                            $loc = get_field("location", $value->ID);
                        ...
                        <tr>
                            ...
                            <td><?= get_field("company_name", $value->ID);   ?></td>
                            <td><?= get_field("job_domain", $value->ID);   ?></td>
                            <td><?php foreach ($uniqueCountryWord[0] as $key => $country) { echo $country." ";   } ?></td>
