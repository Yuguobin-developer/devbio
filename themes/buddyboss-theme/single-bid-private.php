<?php
/**
 * Template name: single-bid-pricate
 *
...
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/css/bg-single.css?id=<?php echo rand(1000,9999); ?>" />
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
            ...
            <p><a href="<?= get_permalink( 409 ); ?>" class="button button_2 button_arrow_left">Return to Private bids</a></p>
            </div>
            
            <h1>Private bid information</h1>
                ...
                <div class="list_item grid_1_1">
                    <div>
                        ...
                        <div style="display: flex;justify-content: space-evenly;flex-wrap: wrap;">
                            <?php $Files = get_field("bid_files", $post->ID); $i = 1;?>
                            <?php foreach ($Files as $key => $value) : ?>
                                <p><a class="button button_dark button_arrow" style="margin-top:0px" target="_blank" href="<?= $value['file_link_url']; ?>" target="_blank">Attached file #<?= $i; ?></a></p>
                            <?php $i++; endforeach; ?>
                        </div>                        
                    </div>                    
                </div>
