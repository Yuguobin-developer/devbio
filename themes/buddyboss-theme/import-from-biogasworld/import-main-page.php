    ...
    <main id="main" class="site-main">            
        ...
        <div class="row">
            ...
            <!--
                ...
                <div class="mb-3">
                    <p>Please select the date from which you want to import the data <span style="color:red">(TEST MODE !)</span></p>
                    <input type="date" name="from_date" class="">
                </div>
                <br>
        -->
                <div class="mb-3">
                    
                        <h4>Please select the data you want to import</h4>
                ...
                <div class="mb-3">
                <button type="submit" name='submit' class="btn btn-primary" style="margin-top: 30px;">Import</button>
                </div>
