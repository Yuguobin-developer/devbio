...
<style>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
            ...
            <p><a href="<?= get_permalink( 409 ); ?>" class="button">< Return to list</a></p>
            </div>
            ...
            <div id="" class="bids_list">
                ...
                <!--
                <div><h3>Link to the bid</h3><a href="<?php //get_field('bid_link', $post->ID); ?>" target="_blank">Direct Link</a></div>
                -->
